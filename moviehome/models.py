...
class MovieDetails(models.Model):
    ...
    movie_details_page = models.CharField(max_length=990, blank=True, default='')
    ...
    movie_audio = models.TextField(max_length=50, blank=True, default='')
    ...
    movie_stars_in_movie = models.CharField(max_length=1000, blank=True, default='')
    movie_type = models.CharField(max_length=50, blank=True, default='')
    ...
    movie_story_short = models.TextField(max_length=500000, blank=True, default='')
    movie_review = models.TextField(max_length=90000, blank=True, default='')
...
class UpcomingDetails(models.Model):
    ...
    movie_director = models.CharField(max_length=50, blank=True, default='')
    movie_story_long = models.TextField(max_length=900000, blank=True, default='')
    movie_story_short = models.TextField(max_length=50000, blank=True, default='')
    movie_review = models.TextField(max_length=90000, blank=True, default='')
    movie_rating = models.FloatField(blank=True, null=True)
    movie_trailer = models.CharField(max_length=2083, blank=True, default='')
    movie_trailer2 = models.CharField(max_length=2083, blank=True, default='')
